...
//
// You can extend the code to handle more types. You can also change it to ignore missing properties, 
// instead of failing like it does now, such that assignments in the field declaration will remain
// unchanged, i.e. be the default.
